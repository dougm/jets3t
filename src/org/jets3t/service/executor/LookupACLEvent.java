...
public class LookupACLEvent extends ServiceEvent {	
	...
	public LookupACLEvent(Throwable t) {
		super(t);
	}

    public LookupACLEvent(int eventStatus) {
        super(eventStatus);
    }

    public LookupACLEvent(int eventStatus, ProgressStatus progressStatus, S3Bucket bucket, S3Object[] objects) {
