...
public class CreateBucketsEvent extends ServiceEvent {	
	...
	public CreateBucketsEvent(Throwable t) {
		super(t);
	}

    public CreateBucketsEvent(int eventStatus) {
        super(eventStatus);
    }

	public CreateBucketsEvent(int eventStatus, ProgressStatus progressStatus, S3Bucket[] buckets) {
