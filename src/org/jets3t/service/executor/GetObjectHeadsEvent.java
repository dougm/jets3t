...
public class GetObjectHeadsEvent extends ServiceEvent {	
	...
	public GetObjectHeadsEvent(Throwable t) {
		super(t);
	}

	public GetObjectHeadsEvent(int eventStatus) {
		super(eventStatus);
	}

	public GetObjectHeadsEvent(int eventStatus, ProgressStatus progressStatus, S3Bucket bucket, S3Object[] objects) {
