...
public class DeleteObjectsEvent extends ServiceEvent {	
	...
	public DeleteObjectsEvent(Throwable t) {
		super(t);
	}

	public DeleteObjectsEvent(int eventStatus) {
		super(eventStatus);
	}

	public DeleteObjectsEvent(int eventStatus, ProgressStatus progressStatus, S3Bucket bucket, S3Object[] objects) {
